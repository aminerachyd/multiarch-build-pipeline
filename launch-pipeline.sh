...
_SERVER_URL=api.apps.diamond.edu.ihost.com:6443
...
#read X86_SERVER_URL
#echo "Enter the api server url for your Power cluster"
#read POWER_SERVER_URL
#echo "Enter the api server url for your Z cluster"
#read Z_SERVER_URL
...
tkn pipeline start $PIPELINE_NAME \
  ...
  --param power-server-url=$POWER_SERVER_URL \
  --param z-server-url=$Z_SERVER_URL \
